...
export default function AdminChatKnowledge() {
    ...
    const hasProcessing = useMemo(() => files.some((item) => ['pending', 'processing'].includes(item.status)), [files]);
    ...
    async function handleDelete(file) {
        const confirmed = window.confirm(
            `Xóa tài liệu "${file.title}" khỏi kho tri thức AI?\n\nThao tác này sẽ gỡ file khỏi OpenAI Vector Store nếu đã đồng bộ.`,
        );
                ...
                >
                    ...
                    <div className="mt-4 space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                className="h-11 w-full rounded-lg border border-slate-200 bg-white px-3 text-sm text-slate-900 outline-none transition focus:border-blue-400 focus:ring-4 focus:ring-blue-100 dark:border-slate-700 dark:bg-slate-950 dark:text-white dark:focus:ring-blue-500/10"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                rows={4}
                                className="w-full resize-none rounded-lg border border-slate-200 bg-white px-3 py-3 text-sm text-slate-900 outline-none transition focus:border-blue-400 focus:ring-4 focus:ring-blue-100 dark:border-slate-700 dark:bg-slate-950 dark:text-white dark:focus:ring-blue-500/10"
                            />
                        </div>
                    </div>
                    ...
                    <div className="mt-4 rounded-lg bg-amber-50 p-3 text-xs leading-5 text-amber-800 dark:bg-amber-500/10 dark:text-amber-200">
                        <div className="flex gap-2">
                            ...
                            <span>
                                Sau khi upload, file có thể ở trạng thái “Đang xử lý”. N8N sẽ đồng bộ lại trạng thái
                                hoàn tất/thất bại.
                            </span>
                        </div>
                    </div>
                        ...
                        <div className="grid gap-3 md:grid-cols-[minmax(0,1fr)_190px_160px_auto]">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="h-10 w-full rounded-lg border border-slate-200 bg-white pl-9 pr-3 text-sm text-slate-900 outline-none transition focus:border-blue-400 focus:ring-4 focus:ring-blue-100 dark:border-slate-700 dark:bg-slate-950 dark:text-white dark:focus:ring-blue-500/10"
                                />
                            </div>
                            ...
                            <select
                                ...
                                className="h-10 rounded-lg border border-slate-200 bg-white px-3 text-sm font-semibold text-slate-700 outline-none transition focus:border-blue-400 focus:ring-4 focus:ring-blue-100 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-200 dark:focus:ring-blue-500/10"
                            >
                                            ...
                                            return (
                                                ...
                                                >
                                                    <td className="px-4 py-4">
                                                        <div className="flex gap-3">
                                                            ...
                                                            <div className="min-w-0">
                                                                <p className="line-clamp-1 font-extrabold text-slate-900 dark:text-white">
                                                                    {file.title}
                                                                </p>
                                                    ...
                                                    <td className="px-4 py-4">
                                                        ...
                                                        >
                                                            {file.isActive ? 'Đang bật' : 'Đang tắt'}
                                                        </span>
                                                    </td>
