    ...
    return (
        <aside className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
            <div className="mb-5 flex items-center justify-between">
                <h2 className="text-lg font-bold text-blue-950 dark:text-white">Bộ lọc</h2>

                <button type="button" onClick={onReset} className="text-sm font-bold text-red-500 hover:text-red-600">
                    Xóa lọc
                </button>
            </div>
