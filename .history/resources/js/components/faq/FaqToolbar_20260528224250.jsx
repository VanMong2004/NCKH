...
function getCategoryIcon(category) {
    ...
    if (value.includes('notification') || value.includes('thong bao')) return HelpCircle;
    if (value.includes('pickup') || value.includes('nhan hang')) return PackageCheck;
    if (value.includes('review') || value.includes('danh gia')) return ShieldCheck;
...
function getCategoryLabel(category) {
    ...
    if (normalized.includes('danh gia') || normalized.includes('review')) return 'Đánh giá';
