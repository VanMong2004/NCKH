...
class AdminPromotionController extends Controller
{
    ...
    private function validationMessages(): array
    {
        return [
            ...
            'slug.required' => 'Vui lòng nhập slug khuyến mãi',
            'slug.max' => 'Slug khuyến mãi không được vượt quá 255 ký tự',
            ...
            'items.*.discount_type.required' => 'Vui lòng chọn loại khuyến mãi',
            'items.*.discount_type.in' => 'Loại khuyến mãi không hợp lệ',
            'items.*.discount_value.required' => 'Vui lòng nhập giá trị khuyến mãi',
            'items.*.discount_value.numeric' => 'Giá trị khuyến mãi không hợp lệ',
        ];
    }
