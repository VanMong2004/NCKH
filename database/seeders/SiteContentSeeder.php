...
class SiteContentSeeder extends Seeder
{
    ...
    private function seedNavbar(): void
    {
        $component = $this->component([
            ...
            'title' => 'CTUT UniShop',
            'subtitle' => 'Kết nối sinh viên với sản phẩm thương hiệu Trường',
    ...
    private function seedFooter(): void
    {
        $component = $this->component([
            ...
            'title' => 'CTUT UniShop',
            'subtitle' => 'Cửa hàng chính thức của Trường Đại học Kỹ thuật - Công nghệ Cần Thơ.',
            'content' => 'Nơi cung cấp các sản phẩm chính hãng, đồng hành cùng sinh viên và giảng viên CTUT.',
            'image' => '/storage/uploads/site-content/logo-20260624131441-foZ2w58N.png',
            'payload' => [
                'copyright' => '© 2026 CTUT UniShop. All rights reserved.',
            ],
            'sort_order' => 4,
            'is_active' => true,
        ]);
