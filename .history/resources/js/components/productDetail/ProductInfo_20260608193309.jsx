...
export default function ProductInfo({ product }) {
    ...
    const availableStock = Number(
        selectedVariant?.available_stock ?? selectedVariant?.stock ?? product.stock ?? 0
    );
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
            ...
            <div className="mt-3 flex flex-wrap items-center gap-2 text-sm">
                ...
                <span className="text-slate-400">
                    ({product.review_count || product.total_reviews || 0} đánh giá)
                </span>
            ...
            {/* QUANTITY */}
            <div className="mt-5">
                <p className="mb-2 text-sm font-bold text-blue-950 dark:text-white">
                    Số lượng
                </p>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-slate-500">
                        {inStock ? `Còn ${availableStock}` : 'Hết hàng'}
                    </span>
                </div>
            </div>
