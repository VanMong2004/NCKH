...
function getCategoryLabel(category) {
    ...
    if (normalized.includes('notification') || normalized.includes('thong bao')) return 'Thông báo';
    if (normalized.includes('pickup') || normalized.includes('nhan hang')) return 'Nhận hàng';
    if (normalized.includes('review') || normalized.includes('danh gia')) return 'Đánh giá';
