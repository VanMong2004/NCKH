            ...
            <div className="md:hidden">
                <div className="flex gap-4 mb-4">
                    ...
                    <div className="flex-1">
                        ...
                        {!item.inStock && <p className="text-xs text-warning font-medium mt-1">Sắp hết</p>}
                        {item.inStock && <p className="text-xs text-success font-medium mt-1">Còn hàng</p>}
                    </div>
                </div>
            ...
            <div className="hidden md:grid grid-cols-12 gap-4 items-center">
                ...
                <div className="col-span-5 flex gap-4">
                    ...
                    <div className="flex-1">
                        ...
                        {item.inStock ? (
                            <p className="text-sm text-success font-medium mt-1">Còn hàng</p>
                        ) : (
                            <p className="text-sm text-warning font-medium mt-1">Sắp hết</p>
                        )}
                    </div>
                </div>
