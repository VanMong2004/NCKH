...
class ProductSeeder extends Seeder
{
    ...
    {
        $products = [
            ['name' => 'Áo thun CTUT K2026', 'category' => 'Áo thun', 'department' => null, 'author' => 'CTUT Store', 'featured' => true, 'views' => 0],
            ['name' => 'Hoodie CTUT Premium', 'category' => 'Hoodie', 'department' => null, 'author' => 'CTUT Store', 'featured' => true, 'views' => 0],
            ...
            ['name' => 'Ly giữ nhiệt CTUT', 'category' => 'Ly giữ nhiệt', 'department' => null, 'author' => 'CTUT Store', 'featured' => true, 'views' => 0],
            ['name' => 'Túi tote CTUT', 'category' => 'Túi tote', 'department' => null, 'author' => 'CTUT Store', 'featured' => true, 'views' => 0],
            ['name' => 'Nón lưỡi trai CTUT', 'category' => 'Nón', 'department' => null, 'author' => 'CTUT Store', 'featured' => false, 'views' => 0],
            ['name' => 'Móc khóa CTUT', 'category' => 'Móc khóa', 'department' => null, 'author' => 'CTUT Store', 'featured' => false, 'views' => 0],
            ['name' => 'Sticker CTUT', 'category' => 'Sticker', 'department' => null, 'author' => 'CTUT Store', 'featured' => false, 'views' => 0],
            ...
            ['name' => 'Sổ tay CTUT', 'category' => 'Sổ tay', 'department' => null, 'author' => 'CTUT Store', 'featured' => false, 'views' => 0],
            ['name' => 'Bút CTUT', 'category' => 'Bút', 'department' => null, 'author' => 'CTUT Store', 'featured' => false, 'views' => 0],
        ];
