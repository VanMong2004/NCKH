                ...
                <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <div className="md:col-span-2 flex justify-end">
                        <button
                            ...
                            disabled={loading}
                            className="rounded-lg bg-blue-950 px-8 py-3 font-bold text-white dark:bg-blue-700"
                        >
    ...
    return (
        <label>
            ...
            <input
                ...
                className="w-full rounded-lg border border-slate-200 bg-white px-4 py-3 text-sm outline-none focus:border-blue-950 dark:border-slate-700 dark:bg-slate-950 dark:text-white"
            />
        </label>
    );
}
