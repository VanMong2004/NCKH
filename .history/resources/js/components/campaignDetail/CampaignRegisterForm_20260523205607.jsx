...
export default function CampaignRegisterForm({ campaign = {} }) {
    ...
    const canRegister = campaign.status === 'active' && selectedProduct;

    async function handleSubmit() {
        if (!canRegister) {
            toast.warning('Chiến dịch chưa mở đăng ký hoặc chưa có sản phẩm');
            return;
        }
        ...
        try {
            ...
            await campaignService.register(campaign.id, {
