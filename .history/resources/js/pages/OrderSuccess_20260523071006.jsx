            ...
            <main className="mx-auto max-w-5xl px-4 py-6">
                ...
                <section className="mt-6 grid gap-6 lg:grid-cols-[1fr_360px]">
                    <div className="space-y-6">
                        <Card title="Thông tin đơn hàng">
                            <div className="grid gap-3 sm:grid-cols-2">
                                ...
                                <InfoBox label="Thanh toán" value={order.payment?.statusText} />
                    ...
                    <div className="space-y-6">
                        ...
                        <Card title="Hướng dẫn nhận hàng">
                            <Guide icon={MapPin}>
                                {order.pickup?.location || 'Nhận hàng tại điểm giao của cửa hàng hoặc theo thông báo của nhân viên.'}
                            </Guide>
                ...
                <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:justify-center">
                    <Link
                        ...
                        className="rounded-xl bg-blue-950 px-6 py-3 text-center text-sm font-bold text-white transition hover:bg-blue-900 dark:bg-blue-700"
                    >
...
function Card({ title, children }) {
    return (
        <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
            <h2 className="mb-4 text-lg font-bold text-blue-950 dark:text-white">
                {title}
            </h2>
            {children}
        </section>
