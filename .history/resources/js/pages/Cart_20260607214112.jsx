                    ...
                    <>
                        <section className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_360px]">
                            ...
                            <div className="space-y-4">
                                <CartSummary
                                    subtotal={selectedIds.length === 0 ? totalPrice : subtotal}
                                    itemCount={selectedIds.length === 0 ? totalItems : selectedCount}
                                    selectedIds={selectedIds}
                                    allCartItemIds={cartItems.map((item) => item.cartItemId)}
                                />
