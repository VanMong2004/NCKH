import { ArrowRight, CalendarDays, Loader2, Megaphone, Newspaper, Search, Sparkles, X } from 'lucide-react';
    ...
    return (
        <section className="rounded-[1.5rem] border border-slate-200 bg-white p-3 shadow-sm dark:border-slate-800 dark:bg-slate-900">
            <div className="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
                ...
                <form onSubmit={onSearch} className="relative min-w-0 xl:w-[340px]">
